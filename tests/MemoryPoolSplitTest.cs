...
{
    /// <summary>
    /// Test class for verifying memory pool split functionality
    /// </summary>
    public static class MemoryPoolSplitTest
    {
        public static void RunAllTests()
        {
            Console.WriteLine("=== Memory Pool Split Tests ===\n");
        ...
        {
            Console.WriteLine("Testing GenericArrayPool...");
            ...
            Console.WriteLine($"  GenericArrayPool Stats: {stats.typeSpecificPools} type-specific, {stats.sizeSpecificPools} size-specific, {stats.totalPooledArrays} total arrays");
            
            Console.WriteLine("  ✓ GenericArrayPool tests passed");
        }
        
        private static void TestChunkPooling()
        {
            Console.WriteLine("Testing ChunkPooling...");
            ...
            Console.WriteLine($"  ChunkPool Stats: {stats.archetypePools} archetype pools, {stats.totalPooledChunks} total chunks, {stats.estimatedMemorySaved} bytes saved");
            
            Console.WriteLine("  ✓ ChunkPooling tests passed");
        }
        
        private static void TestMemoryPoolOptimizer()
        {
            Console.WriteLine("Testing MemoryPoolOptimizer...");
            ...
            Console.WriteLine("  ✓ MemoryPoolOptimizer tests passed");
        }
