...
{
    /// <summary>
    /// Standalone test for memory pool split functionality
    /// </summary>
    public static class MemoryPoolSplitStandaloneTest
    {
            public static void RunTest()
    {
        Console.WriteLine("=== Memory Pool Split Standalone Test ===\n");
